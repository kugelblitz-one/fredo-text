...
module.exports = {
  ...
  help: `💬💬💬${newLine(1)}Need a quick helper? Need a fast answer to a question?`+
  `${newLine(2)}Start conversation with GPT.  Send informative prompts and get answers.`+
      `${newLine(2)}💡 _Tip: start with the word gpt and try to make your prompts informative._${newLine(2)}${bold(
    'Examples:'
