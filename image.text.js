...
module.exports = {
  ...
  help: `🏞️🏞️🏞️${newLine()}Need a quick image reference? Fredo creates images from text captions for a wide range of concepts expressible in natural language.${newLine(2)}💡 Tip: start with the word image and specify after that description of your desired image${newLine(2)}`+
